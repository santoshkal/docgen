...
Generated: 2025-11-19T16:35:55.796815

## Request Metadata
- **Section ID**: divisions-overview
- **Section Title**: COBOL Division Structure
- **Model**: gpt-4.1
- **Chunk Number**: N/A
- **Pass Number**: 1

## Token Counts (measured with tiktoken)
- **System Prompt**: 283 tokens
- **User Prompt**: 3,745 tokens
- **Total Input**: 4,028 tokens
...
Your task is to generate documentation for the section: "COBOL Division Structure" (ID: divisions-overview)
