...
- **System Prompt**: ~353 tokens
- **User Prompt**: ~42,307 tokens
- **Total Input**: ~42,660 tokens
...
Your task is to generate documentation for the section: "Data Flow Diagram" (ID: dfa-diagram)
